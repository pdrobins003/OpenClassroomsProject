...
while True:
    # Section 3a: Construct the URL for the current page
...
def extract_book_data(book_url):
    ...
    # Section 8a:Check if the elements exist and handle missing elements
...
def save_image(image_url, title, book_images='book_images'):
    ...
    image_filename = os.path.join(book_images, f"{title.replace('/', '_')}.jpg")
...
def extract_books_from_category(category_url):
    ...
    while page_url:
        ...
        for link in book_links:
            ...
            book_data.append(extract_book_data(book_url))

        # Section 14: Scrape next page
...
# Section 15: Create a directory for the csv files
if not os.path.exists('book_data'):
    os.makedirs('book_data')

# Section 16: Loop for each category to get all data
for category_name, category_url in category_urls.items():
    ...
    # Section 17: Write pulled data to csv file
...
# Section 18: Write requirement file
